...
mySettings = {
	...
	markupSet: [
		{name:'# with overline, for parts', text:'##', key:'1', placeHolder:'Part title (H1)..', closeWith: miu.makeMarkDown('#')},
		...
		{name:'^, for sub-subsections', text:'^', key:'5', placeHolder:'Sub-subsection title..', closeWith: miu.makeMarkDown('^') },
